...
impl Video {
    ...
    pub async fn lookup_id(
        ...
        let video = sqlx::query_as!(
            Video,
            "SELECT id, processed, source, url, mp4_url, thumb_url, chat_id, message_id FROM videos WHERE id = $1",
            id
        )
        .fetch_optional(conn)
        .await?;
    ...
    pub async fn lookup_url(
        ...
        let video = sqlx::query_as!(
            Video,
            "SELECT id, processed, source, url, mp4_url, thumb_url, chat_id, message_id FROM videos WHERE url = $1",
            url
        )
        .fetch_optional(conn)
        .await?;
    ...
    pub async fn set_message_id(
        ...
        sqlx::query!(
            "UPDATE videos SET chat_id = $1, message_id = $2 WHERE id = $3",
            chat_id,
            message_id,
            id
        )
